...
if( !class_exists( 'CMB2_Tabs' ) ) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-tabs', get_stylesheet_directory_uri() . '/inc/CMB2/plugins/cmb2-tabs-master/js/tabs.js', array( 'jquery' ), self::VERSION, true );
            wp_enqueue_script( 'cmb-tabs' );

            wp_enqueue_style( 'cmb-tabs', get_stylesheet_directory_uri() . '/inc/CMB2/plugins/cmb2-tabs-master/css/tabs.css', array(), self::VERSION );
        ...
        public function setup_dark_mode() {
            wp_enqueue_style( 'cmb-tabs-dark-mode', get_stylesheet_directory_uri() . '/inc/CMB2/plugins/cmb2-tabs-master/css/dark-mode.css', array(), self::VERSION );
